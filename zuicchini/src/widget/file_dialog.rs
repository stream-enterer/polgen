...
use super::file_selection_box::FileSelectionBox;
use super::look::Look;
...
impl FileDialog {
    pub fn new(mode: FileDialogMode, look: std::rc::Rc<Look>) -> Self {
        ...
        fsb.border_mut().outer = super::border::OuterBorderType::None;
        fsb.border_mut().inner = super::border::InnerBorderType::None;
